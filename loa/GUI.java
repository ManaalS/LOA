...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        super(title, true);
        addMenuButton("Game Options->New", this::newGame);
        addMenuButton("Game Options->Quit", this::quit);
        addMenuButton("Player Options->Auto White", this::autoWhite);
        addMenuButton("Player Options->Manual White", this::manualWhite);
        addMenuButton("Player Options->Auto Black", this::autoBlack);
        addMenuButton("Player Options->Manual Black", this::manualBlack);
        addMenuButton("Game Information->Help", this::help);
        addMenuButton("Game Information->About", this::about);
        addMenuButton("Game Options->Undo", this::undo);
    ...
    public void update(Game controller) {
        ...
        if (board.winner() != null) {
            setLabel("CurrentTurn",
                     String.format("Congrats, %s player, you win!",
                                   board.winner().fullName()));
        } else {
            setLabel("CurrentTurn",
                     String.format("Welcome to LOA! %s player, your move! ",
                             board.turn().fullName()));
        }
